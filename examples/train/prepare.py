"""Prepare a dataset for PET training.

Reads an extended XYZ file and writes train/valid splits in marathon format.
Set the DATASETS environment variable to the root directory where prepared
...
prepare(
    ...
    folder=datasets / "my_project/train",
    reporter=reporter,
    batch_size=500,
...
prepare(
    ...
    folder=datasets / "my_project/valid",
    reporter=reporter,
    batch_size=500,
    samples_per_composition=100,
    properties=PROPERTIES,
